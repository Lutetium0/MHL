...
config = Config(
    ...
    csharp_out_dir="../Assets/ProjectDir/HotUpdate/ProtoGenScripts",
    csharp_cmd_file="../Assets/ProjectDir/HotUpdate/ProtoGenScripts/CmdCode.cs",
    cmdcode_out_file="ServerLuaCmdOutput/CmdCode.lua"
)
...
try:
    ...
    protolist, proto_list_with_file = intelliSense.run(
        ...
        game_dir="ServerGameFolder/",
        game_config_dir="ServerConfigFolder/",
